...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_page_hero_links_link_appearance" AS ENUM('default', 'outline', 'solid', 'outlineGhost', 'send', 'github', 'linkedin');
  ...
  CREATE TYPE "public"."enum_pages_blocks_page_projects_teaser_variant" AS ENUM('teaser', 'cards', 'hairline');
  CREATE TYPE "public"."enum_pages_blocks_page_projects_teaser_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_page_projects_teaser_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_page_projects_teaser_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_page_hero_links_link_appearance" AS ENUM('default', 'outline', 'solid', 'outlineGhost', 'send', 'github', 'linkedin');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_page_projects_teaser_variant" AS ENUM('teaser', 'cards', 'hairline');
  CREATE TYPE "public"."enum__pages_v_blocks_page_projects_teaser_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_page_projects_teaser_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_page_projects_teaser_populate_by" AS ENUM('collection', 'selection');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_page_hero" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" "enum_pages_blocks_page_hero_variant" DEFAULT 'portrait',
  	"show_plot_line" boolean DEFAULT true,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_page_about" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"layout" "enum_pages_blocks_page_about_layout" DEFAULT 'single',
  	"image_id" integer,
  	"link_type" "enum_pages_blocks_page_about_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum_pages_blocks_page_about_link_appearance" DEFAULT 'default',
  	"section_section_id" varchar,
  	"section_background_container" boolean,
  	"section_theme" "theme" DEFAULT 'auto',
  	"section_background" "section_background" DEFAULT 'none',
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_page_skills" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" "enum_pages_blocks_page_skills_variant" DEFAULT 'cards',
  	"section_section_id" varchar,
  	"section_background_container" boolean,
  	"section_theme" "theme" DEFAULT 'auto',
  	"section_background" "section_background" DEFAULT 'none',
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_page_projects_teaser" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" "enum_pages_blocks_page_projects_teaser_variant" DEFAULT 'teaser',
  	"link_type" "enum_pages_blocks_page_projects_teaser_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum_pages_blocks_page_projects_teaser_link_appearance" DEFAULT 'default',
  	"populate_by" "enum_pages_blocks_page_projects_teaser_populate_by" DEFAULT 'collection',
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_page_projects_teaser_locales" (
  	"eyebrow" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_page_hero" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"variant" "enum__pages_v_blocks_page_hero_variant" DEFAULT 'portrait',
  	"show_plot_line" boolean DEFAULT true,
  	"status_is_available" boolean DEFAULT false,
  	"email" varchar,
  	"background_image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_page_about" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"layout" "enum__pages_v_blocks_page_about_layout" DEFAULT 'single',
  	"image_id" integer,
  	"link_type" "enum__pages_v_blocks_page_about_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum__pages_v_blocks_page_about_link_appearance" DEFAULT 'default',
  	"section_section_id" varchar,
  	"section_background_container" boolean,
  	"section_theme" "theme" DEFAULT 'auto',
  	"section_background" "section_background" DEFAULT 'none',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_page_skills" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"variant" "enum__pages_v_blocks_page_skills_variant" DEFAULT 'cards',
  	"section_section_id" varchar,
  	"section_background_container" boolean,
  	"section_theme" "theme" DEFAULT 'auto',
  	"section_background" "section_background" DEFAULT 'none',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_page_projects_teaser" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"variant" "enum__pages_v_blocks_page_projects_teaser_variant" DEFAULT 'teaser',
  	"link_type" "enum__pages_v_blocks_page_projects_teaser_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum__pages_v_blocks_page_projects_teaser_link_appearance" DEFAULT 'default',
  	"populate_by" "enum__pages_v_blocks_page_projects_teaser_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 6,
  	"github_url" varchar,
  	"section_section_id" varchar,
  	"section_background_container" boolean,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_locales" (
  	"eyebrow" varchar,
  	"title" varchar DEFAULT 'Featured Projects',
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "projects_locales" (
  	"title" varchar,
  	"case_study_tag" varchar,
  	"case_study_problem" varchar,
  	"case_study_contribution" varchar,
  	"case_study_context" varchar,
  	"case_study_decisions" varchar,
  	"case_study_outcome" varchar,
  	"content" jsonb,
  	"meta_title" varchar,
  	"meta_image_id" integer,
  	"meta_description" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_projects_v" (
  	...
  	"version_case_study_year" varchar,
  	"version_appearance_header_overrides_theme" "theme" DEFAULT 'dark',
  	"version_appearance_header_overrides_background" boolean DEFAULT false,
  	"version_appearance_header_overrides_overlay" boolean DEFAULT false,
  	"version_published_at" timestamp(3) with time zone,
  ...
  CREATE TABLE IF NOT EXISTS "_projects_v_locales" (
  	"version_title" varchar,
  	"version_case_study_tag" varchar,
  	"version_case_study_problem" varchar,
  	"version_case_study_contribution" varchar,
  	"version_case_study_context" varchar,
  	"version_case_study_decisions" varchar,
  	"version_case_study_outcome" varchar,
  	"version_content" jsonb,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "copyright" (
  	...
  	"start_date" timestamp(3) with time zone DEFAULT '2026-08-06T20:33:04.636Z' NOT NULL,
  	"link" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_page_projects_teaser" ADD CONSTRAINT "pages_blocks_page_projects_teaser_section_background_image_id_media_id_fk" FOREIGN KEY ("section_background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_page_projects_teaser" ADD CONSTRAINT "pages_blocks_page_projects_teaser_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_page_projects_teaser_locales" ADD CONSTRAINT "pages_blocks_page_projects_teaser_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_page_projects_teaser"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_page_projects_teaser" ADD CONSTRAINT "_pages_v_blocks_page_projects_teaser_section_background_image_id_media_id_fk" FOREIGN KEY ("section_background_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_page_projects_teaser" ADD CONSTRAINT "_pages_v_blocks_page_projects_teaser_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_page_projects_teaser_locales" ADD CONSTRAINT "_pages_v_blocks_page_projects_teaser_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_page_projects_teaser"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_page_projects_teaser_order_idx" ON "pages_blocks_page_projects_teaser" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_page_projects_teaser_parent_id_idx" ON "pages_blocks_page_projects_teaser" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_page_projects_teaser_path_idx" ON "pages_blocks_page_projects_teaser" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_page_projects_teaser_section_section_background_image_idx" ON "pages_blocks_page_projects_teaser" USING btree ("section_background_image_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "pages_blocks_page_projects_teaser_locales_locale_parent_id_unique" ON "pages_blocks_page_projects_teaser_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_order_idx" ON "_pages_v_blocks_page_projects_teaser" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_parent_id_idx" ON "_pages_v_blocks_page_projects_teaser" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_path_idx" ON "_pages_v_blocks_page_projects_teaser" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_section_section_background_image_idx" ON "_pages_v_blocks_page_projects_teaser" USING btree ("section_background_image_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "_pages_v_blocks_page_projects_teaser_locales_locale_parent_id_unique" ON "_pages_v_blocks_page_projects_teaser_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_page_projects_teaser" CASCADE;
  DROP TABLE "pages_blocks_page_projects_teaser_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_page_projects_teaser" CASCADE;
  DROP TABLE "_pages_v_blocks_page_projects_teaser_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_page_projects_teaser_variant";
  DROP TYPE "public"."enum_pages_blocks_page_projects_teaser_link_type";
  DROP TYPE "public"."enum_pages_blocks_page_projects_teaser_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_page_projects_teaser_populate_by";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_page_projects_teaser_variant";
  DROP TYPE "public"."enum__pages_v_blocks_page_projects_teaser_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_page_projects_teaser_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_page_projects_teaser_populate_by";
